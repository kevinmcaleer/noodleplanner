...
## Goal
Enable the scheduling engine to generate a simple timeline visualization of the major phases in a project, based on the Markdown input summary tasks and milestones. The timeline should show the start and end dates for each phase, making it easy to see the overall flow and duration of the project at a glance.
...
## Requirements
- Parse Markdown to identify major phases and their start/end dates.
- Phases are identified by Summary tasks in the Markdown.
...
- Timeline is generated automatically from the Markdown input.
- Works for any valid project Markdown with Sumamry tasks.
