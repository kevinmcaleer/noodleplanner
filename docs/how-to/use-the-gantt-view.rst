...
Use the zoom controls at the top of the Gantt view to change the time scale:

- **Days** — shows individual days (best for short projects)
- **Weeks** — groups by week
- **Months** — shows months (default for most projects)
- **Quarters** — groups by quarter
- **Years** — overview for long programmes
