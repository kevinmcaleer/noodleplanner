...
from .scheduling_engine import yaml_to_markdown_table
...
def _command_render(args: argparse.Namespace) -> int:
    markdown = yaml_to_markdown_table(str(args.yaml_path))
...
def build_parser() -> argparse.ArgumentParser:
    ...
    render = subparsers.add_parser(
        "render",
        help="Render a YAML project file to markdown schedules.",
    )
    render.add_argument("yaml_path", type=Path, help="Path to the YAML project file.")
    render.add_argument(
        "--split-markdown",
        action="store_true",
