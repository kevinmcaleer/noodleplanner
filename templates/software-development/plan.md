...
Development
  Backend development "API and server-side logic"
    Database setup @dev 2days [depends Project planning milestone] 0%
  ...
  Frontend development "User interface implementation"
    Component framework @ui 3days [depends UI/UX design mockups] 0%
    * Pages and routing @ui 5days 0%
    * API integration @ui 2days 0%
    * Responsive design @ui 2days 0%
  Development complete milestone @dev 0days [depends Integration services, Responsive design] 0% "Core development finished"

Testing & Quality Assurance
  Unit testing @dev 5days [depends Integration services] 0% "Automated unit test coverage"
